...
<form id="nada-filter-form">
    <div class="accordion" id="nadaAccordion">
        ...
        if (!empty($data_ID['fr']['values'])) {

            foreach ($data_ID['fr']['values'] as $filter_key) {
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="heading-<?php echo $index; ?>">
                            <button class="accordion-button collapsed d-flex justify-content-between align-items-center"
                                ...
                                Années de début et de fin de la collecte
                        ...
                        <div id="collapse-<?php echo $index; ?>" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="from"><?php echo __('De :', 'nada-id'); ?></label>
                                    ...
                                    <div class="col-md-6">
                                        <label for="to"><?php echo __('À :', 'nada-id'); ?></label>
                                        <select id="to" name="to">
                                            ...
                                            foreach ($data_ID['fr']['values'] as $f2) {
...
<script>
    jQuery(document).ready(function($) {
        $("#facet-fr #nada-filter-form").on("change", "input, select", function() {
            const params = getSearchFormParams();
            const filtreData = $("#facet-fr #nada-filter-form").serializeArray();

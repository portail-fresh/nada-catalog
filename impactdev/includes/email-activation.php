        ...
        <table align="left" role="presentation" cellpadding="0" cellspacing="0" border="0" class="email-container"
          ...
          <tr>
            <td style="font-size:15px;line-height:1.6;color:#333333;text-align:left;">
              ...
              <p>Merci pour votre inscription sur FReSH.  
               Pour activer votre compte, veuillez cliquer sur le bouton ci-dessous :</p>

               <!-- BOUTON ACTIVATION -->
              <p>
              <a href="[activation_link]" class="" target="_blank"
          ...
          <tr>
            <td style="font-size:15px;line-height:1.6;color:#333333;text-align:left;">
             ...
             <p>Thank you for registering on FReSH.

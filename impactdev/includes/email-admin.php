        ...
        <table align="left" role="presentation" cellpadding="0" cellspacing="0" border="0" class="email-container"
          ...
          <tr>
            <td style="font-size:15px;line-height:1.6;color:#333333;text-align:left;">
              <p>Bonjour Admin,</p>
             <p>Un nouvel utilisateur s\'est inscrit sur le portail FReSH avec l\'adresse e-mail suivante :</p>
			  <p> [email]
			  </p>
          ...
          <tr>
            <td style="font-size:15px;line-height:1.6;color:#333333;text-align:left;">
             <p>Hello Admin,</p>
              <p>A new user has registered on the FReSH portal with the following email address: </p>
               <p> [email]
			  </p>
			  <p>Best regards,</p>
              <p>The FReSH Team</p>

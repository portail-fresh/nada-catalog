        ...
        <table align="left" role="presentation" cellpadding="0" cellspacing="0" border="0" class="email-container"
          ...
          <tr>
            <td style="font-size:15px;line-height:1.6;color:#333333;text-align:left;">
              ...
              <p>Nous avons reçu une demande pour réinitialiser le mot de passe de votre compte sur FReSH.
              <p> Si cela est une erreur, ignorez simplement cet email et aucune modification ne sera apportée à votre compte.</p>
              <p>Pour réinitialiser votre mot de passe, veuillez cliquer sur le lien ci-dessous :</p>
               <!-- BOUTON ACTIVATION -->
              <p>
              <a href="[reset_url]" class="" target="_blank"
          ...
          <tr>
            <td style="font-size:15px;line-height:1.6;color:#333333;text-align:left;">
             ...
             <p>Nous We have received a request to reset the password for your FReSH account.</p>
             <p>If this is a mistake, simply ignore this email and no changes will be made to your account.</p>

  ...
  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
    <tr>
      <td align="left" style="padding:20px 10px;">
        ...
        <!-- Main container -->
        <table align="left" role="presentation" cellpadding="0" cellspacing="0" border="0" class="email-container" style="width:100%;max-width:600px; solid #e6e6e6;border-radius:6px;overflow:hidden;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" class="two-col" style="border-collapse:collapse; text-align:left;">
                <tr>
                  ...
                  <td class="col stack footer-logo" style="width:25%; padding-right:12px; border-right:1px solid #00a6e2; vertical-align:top;">
                    <a href="{project_link}" target="_blank" style="text-decoration:none;">
                      <img src="{logo_url}"
                        width="100%" style="display:block; max-width:100px; height:auto;" alt="Logo FReSH">
                    </a>
                  </td>
